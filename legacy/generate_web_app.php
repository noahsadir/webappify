...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  echo '{"status":"failure","message":"Post method not detected"}';
}
...
function generateApp($unique_id,$web_link,$name,$image,$rounded){
  if (!mkdir("apps/".$unique_id)){
    ...
    $manifest_webmanifest = '{"short_name": "'.$name.'","name": "'.$name.'","description": "Web app for '.$name.'","icons": [{"src": "main-icon.png","type": "image/png","sizes": "1024x1024"},{"src": "main-icon-192.png","type": "image/png","sizes": "192x192","purpose": "any maskable"},{"src": "main-icon-512.png","type": "image/png","sizes": "512x512","purpose": "any maskable"}],"start_url": "/webappify/apps/'.$unique_id.'/index.html","background_color": "#FFFFFF","display": "standalone","scope": "/webappify/apps/'.$unique_id.'/","theme_color": "#222222","shortcuts":[]}';
    ...
    $newLink = 'https://investalyze.app/webappify/apps/'.$unique_id.'/index.html';
